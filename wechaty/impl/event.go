...
type (
  ...
  EventFriendshipConfirm func(friendship *user.Friendship)
  EventFriendshipVerify  func(friendship *user.Friendship)
  EventFriendshipReceive func(friendshipReceive *user.FriendshipReceive)
